...
node {
  name: "keep_prob/Assign"
  op: "Assign"
  input: "keep_prob"
  input: "keep_prob/initial_value"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "is_trining/Assign"
  op: "Assign"
  input: "is_trining"
  input: "is_trining/initial_value"
  attr {
    key: "T"
    value {
      type: DT_BOOL
...
node {
  name: "init"
  op: "NoOp"
  input: "^keep_prob/Assign"
  input: "^is_trining/Assign"
  ...
  attr {
    ...
    value {
      tensor {
        ...
        string_val: "is_trining"
        string_val: "keep_prob"
      }
    }
  }
}
