package com.example.isai.final_project.convolutionalNeuralNetwork;
...
import com.example.isai.final_project.utils.*;
...
public class TensorFlowImageListener implements ImageReader.OnImageAvailableListener {
    ...
    private static final int INPUT_SIZE = 128; // 224
    private static final int IMAGE_MEAN = 124; // 117
    private static final float IMAGE_STD = 22; // 1
    private static final String INPUT_NAME = "input_node:0"; // "input:0";
    private static final String OUTPUT_NAME = "fully_connected_output/output_node"; // "output:0"

    private static final String MODEL_FILE = "file:///android_asset/trained_graph.pb";
